...
public partial class Northwind3Context : DbContext
{
    public Northwind3Context()
    {
    }

    public Northwind3Context(DbContextOptions<Northwind3Context> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<Persons1> Persons1s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-BLNTEBH7\\SQLEXPRESS;Database=northwind3;Trusted_Connection=True;TrustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Personid).HasName("PK__Persons__AA2CFFDD4C9F824C");
        ...
        modelBuilder.Entity<Persons1>(entity =>
        {
            entity.HasKey(e => e.Personid).HasName("PK__Persons1__AA2CFFDD8E8E2CAB");

            entity.ToTable("Persons1");
